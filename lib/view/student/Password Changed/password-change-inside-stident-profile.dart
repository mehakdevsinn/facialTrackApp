...
class ChangePasswordScreenStudentProfile extends StatefulWidget {
  const ChangePasswordScreenStudentProfile({super.key});

  @override
  State<ChangePasswordScreenStudentProfile> createState() =>
      _ChangePasswordScreenStudentProfileState();
}

class _ChangePasswordScreenStudentProfileState

...
class _TimeframeScreenState extends State<TimeframeScreen>
      ...
      onTap: () {
        if (isReady) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text(
                "Please select a complete range",
          ...
          decoration: BoxDecoration(
            gradient: isReady
                ? const LinearGradient(
                    colors: [Color(0xFF6A91E8), Color(0xFF4A69BB)],
                  )
            ...
            boxShadow: isReady
                ? [
                    BoxShadow(
                      color: const Color(0xFF4A69BB).withOpacity(0.3),
                      blurRadius: 10,
                      offset: const Offset(0, 5),
                    ),
                  ]
